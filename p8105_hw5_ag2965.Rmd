...
The sample average of mu-hat for across testes for which the null hypothesis is rejected is not approximately equal to the true value of mu because these samples were sufficiently different than mu, allowing for the rejection of the null hypothesis.
