...
homicides_closed <- read.csv(url("https://raw.githubusercontent.com/washingtonpost/data-homicides/master/homicide-data.csv"))%>%
  janitor::clean_names()%>%
    unite(city_state, c(city, state), sep = ", ")%>%
    group_by(city_state)%>%
...
homicides_open <- read.csv(url("https://raw.githubusercontent.com/washingtonpost/data-homicides/master/homicide-data.csv"))%>%
  janitor::clean_names()%>%
    unite(city_state, c(city, state), sep = ", ")%>%
    group_by(city_state)%>%
